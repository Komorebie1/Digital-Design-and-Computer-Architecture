...
// Command     : write_verilog -force -mode synth_stub -rename_top test_ROM_distributed -prefix
//               test_ROM_distributed_ test_ROM_distributed_stub.v
...
module test_ROM_distributed(a, d, clk, we, spo)
